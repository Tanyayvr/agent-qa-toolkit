...
describe("eu-ai-evidence-site", () => {
  ...
  it(
    ...
    expect(landing).toContain("EU AI Act package builder for high-risk AI systems");
    ...
    expect(landing).toContain("Why this product exists");
    expect(landing).toContain("Most teams already have draft documents, logs, testing notes, and internal records.");
    expect(landing).toContain("2 August 2026");
    expect(landing).toContain("Document draft");
    expect(landing).toContain("Why do teams struggle to prepare an EU AI Act package?");
    expect(landing).toContain("What documents are included in the EU AI Act package?");
    expect(landing).toContain("Which EU AI Act articles and annexes does this product cover?");
    expect(landing).not.toContain("Choose your entry path");
    expect(landing).not.toContain("Choose the next step");
    expect(landing).not.toContain("What teams usually need under review");
    ...
    expect(builder).toContain("products/eu-ai-act/docs/runbook.md");
    ...
    expect(agentCheck).not.toContain("blob/main/docs/eu-ai-act-operator-runbook.md");
    expect(starter).toContain("Run a first EU AI Act starter check on your own agent");
    expect(starter).toContain("Starter command");
    expect(starter).toContain("cd products/eu-ai-act");
    expect(starter).toContain("npm run starter");
    ...
    expect(pricing).toContain("UP TO 3 AGENTS");
    expect(pricing).toContain("UP TO 10 AGENTS");
    expect(pricing).toContain("ENTERPRISE");
    expect(pricing).toContain("Free self-serve EU AI Act path");
    expect(pricing).toContain("First package help for one real system");
    expect(pricing).toContain("Supported self-hosted use for up to 3 agents");
    expect(pricing).toContain("Supported self-hosted use for up to 10 agents");
    expect(pricing).toContain("Enterprise support for broader rollout");
    expect(pricing).toContain("Open EU open-source guide");
    expect(pricing).toContain("products/eu-ai-act/README.md");
    expect(pricing).toContain("EUR499");
    expect(pricing).toContain("EUR299/month");
    expect(pricing).toContain("EUR890/month");
    expect(pricing).toContain("+EUR120/month each");
    ...
    expect(docs).not.toContain("blob/main/docs/eu-ai-act-operator-runbook.md");
    ...
    expect(technology).toContain("cd products/eu-ai-act");
    expect(technology).toContain("npm run package --");
    ...
    expect(technology).not.toContain("blob/main/docs/eu-ai-act-self-hosted-guidance.md");
    ...
    expect(deLanding).toContain("EU-KI-Verordnungs Paket-Builder fuer Hochrisiko-KI-Systeme");
    expect(deLanding).toContain("2. August 2026");
    expect(deLanding).toContain("Warum dieses Produkt existiert");
    ...
    expect(frLanding).toContain("Builder de package EU AI Act pour systemes IA a haut risque");
    expect(frLanding).toContain("2 aout 2026");
    expect(frLanding).toContain("Pourquoi ce produit existe");
