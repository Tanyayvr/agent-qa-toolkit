...
0. Normative scope
MUST (v5 compliance)
- report.html, compare-report.json, case-<case_id>.html, assets/ exist.
...
- assets/ (self-contained payloads)
...
All href fields stored in compare-report.json MUST be:
...
Note: This rule applies to href fields only. URLs may appear as data (e.g., security.signals[].details.urls).
