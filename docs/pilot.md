...
- Long‑term support beyond the pilot window
- Custom compliance/verification profiles beyond the pilot scope

## How to apply
Open a Pilot Request issue:
https://github.com/Tanyayvr/agent-qa-toolkit/issues/new?template=pilot_request.yml

If slots are full, use the Pilot Waitlist:
https://github.com/Tanyayvr/agent-qa-toolkit/issues/new?template=pilot_waitlist.yml
